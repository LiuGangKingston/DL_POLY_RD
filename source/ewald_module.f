...
c     atomic virial stress contributions - r. darkins
c     (there is some room for optimisation)
     ...
     x                         rkz3*zzz(j)
                          ...
                          qeav=cos(rdtmp)*sumqe(1)+
     x                         sin(rdtmp)*sumqe(2)
                          qeav=qeav*chge(j)

                          thisvir(1)=scal1*qeav*(akv*rkx3*rkx3-akk)
                          thisvir(2)=scal1*qeav*akv*rkx3*rky3
                          thisvir(3)=scal1*qeav*akv*rkx3*rkz3
                          thisvir(4)=scal1*qeav*(akv*rky3*rky3-akk)
                          thisvir(5)=scal1*qeav*akv*rky3*rkz3
                          thisvir(6)=scal1*qeav*(akv*rkz3*rkz3-akk)
                          
                          call update_atomicvirial(j,2)
...
c     atomic virial contributions - r. darkins

                if(lvirupdate)then

                   thisvir(1)=-xdf(m)*fx*0.5d0
                   thisvir(2)=-xdf(m)*fy*0.5d0
                   thisvir(3)=-xdf(m)*fz*0.5d0
                   thisvir(4)=-ydf(m)*fy*0.5d0
                   thisvir(5)=-ydf(m)*fz*0.5d0
                   thisvir(6)=-zdf(m)*fz*0.5d0
                   
                   call update_atomicvirial(iatm,2)
                   call update_atomicvirial(jatm,2)
...
c     atomic virial contribution - r. darkins
