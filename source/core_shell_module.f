...
c     calculate stress tensor
          ...
          if(lvirupdate)then
             ...
             thisvir(1)=-xdf(m)*ffx*0.5d0
             thisvir(2)=-xdf(m)*ffy*0.5d0
             thisvir(3)=-xdf(m)*ffz*0.5d0
             thisvir(4)=-ydf(m)*ffy*0.5d0
             thisvir(5)=-ydf(m)*ffz*0.5d0
             thisvir(6)=-zdf(m)*ffz*0.5d0
             
             call update_atomicvirial(i,10)
             call update_atomicvirial(j,10)
