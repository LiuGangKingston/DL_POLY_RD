...
c     atomic virial contribution - r. darkins
            ...
            if(lvirupdate) then
               ...
               thisvir(1)=-(xab*fbx+xac*fcx+xad*fdx)*0.25d0
               thisvir(2)=-(yab*fbx+yac*fcx+yad*fdx)*0.25d0
               thisvir(3)=-(zab*fbx+zac*fcx+zad*fdx)*0.25d0
               thisvir(4)=-(yab*fby+yac*fcy+yad*fdy)*0.25d0
               thisvir(5)=-(yab*fbz+yac*fcz+yad*fdz)*0.25d0
               thisvir(6)=-(zab*fbz+zac*fcz+zad*fdz)*0.25d0

               call update_atomicvirial(ia,4)
               call update_atomicvirial(ib,4)
               call update_atomicvirial(ic,4)
               call update_atomicvirial(id,4)
