...
c     atomic virial contribution - r. darkins
          ...
          if(lvirupdate)then
             ...
             thisvir(1)=-(rab*xab*fxa+rbc*xbc*fxc)*ONE_THIRD
             thisvir(2)=-(rab*xab*fya+rbc*xbc*fyc)*ONE_THIRD
             thisvir(3)=-(rab*xab*fza+rbc*xbc*fzc)*ONE_THIRD
             thisvir(4)=-(rab*yab*fya+rbc*ybc*fyc)*ONE_THIRD
             thisvir(5)=-(rab*yab*fza+rbc*ybc*fzc)*ONE_THIRD
             thisvir(6)=-(rab*zab*fza+rbc*zbc*fzc)*ONE_THIRD
             
             call update_atomicvirial(ia,0)
             call update_atomicvirial(ib,0)
             call update_atomicvirial(ic,0)
