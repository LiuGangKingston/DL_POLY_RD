...
c     atomic virial contributions - r. darkins
          ...
          if(lvirupdate) then
             ...
             thisvir(1)=-xdab(ii)*fx*0.5d0
             thisvir(2)=-xdab(ii)*fy*0.5d0
             thisvir(3)=-xdab(ii)*fz*0.5d0
             thisvir(4)=-ydab(ii)*fy*0.5d0
             thisvir(5)=-ydab(ii)*fz*0.5d0
             thisvir(6)=-zdab(ii)*fz*0.5d0
             
             call update_atomicvirial(ia,1)
             call update_atomicvirial(ib,1)
