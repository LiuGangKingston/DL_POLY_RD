...
c     atomic virial contribution - r. darkins
          ...
          if(lvirupdate) then
             ...
             thisvir(1)=-(xab*fax+xbc*(fb1x-fcx)-xcd*fd1x)*0.25d0
             thisvir(2)=-(yab*fax+ybc*(fb1x-fcx)-ycd*fd1x)*0.25d0
             thisvir(3)=-(zab*fax+zbc*(fb1x-fcx)-zcd*fd1x)*0.25d0
             thisvir(4)=-(yab*fay+ybc*(fb1y-fcy)-ycd*fd1y)*0.25d0
             thisvir(5)=-(yab*faz+ybc*(fb1z-fcz)-ycd*fd1z)*0.25d0
             thisvir(6)=-(zab*faz+zbc*(fb1z-fcz)-zcd*fd1z)*0.25d0

             call update_atomicvirial(ia,3)
             call update_atomicvirial(ib,3)
             call update_atomicvirial(ic,3)
             call update_atomicvirial(id,3)
...
c     stress tensor for coulombic 1-4 term
              ...
              if(lvirupdate)then
                 ...
                 thisvir(1)=-xad*fx*0.5d0
                 thisvir(2)=-xad*fy*0.5d0
                 thisvir(3)=-xad*fz*0.5d0
                 thisvir(4)=-yad*fy*0.5d0
                 thisvir(5)=-yad*fz*0.5d0
                 thisvir(6)=-zad*fz*0.5d0
